public class Game {
  ...
  public Game(String name) {
    ...
    this.name = name;
    System.out.println("Game name initialized.");
  }
  ...
  public void addPlayer(Player player) {
    ...
    System.out.println("Player successfully added to scoreboard.");
  }
...
//    System.out.println("prettyPrint works\n" + scoreboard.prettyPrint());
//    System.out.println(scoreboard);
    toReturn += scoreboard.toString()+"\n";
//    System.out.println("toString works: " + scoreboard.toString());
//    System.out.println("yay returns");
    return toReturn;
  }
